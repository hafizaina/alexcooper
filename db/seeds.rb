...
auction1 = Auction.create(date: 'November 3, 2016', location: 'Towson, MD')
auction2 = Auction.create(date: 'November 4, 2016', location: 'Towson, MD')
auction3 = Auction.create(date: 'November 5, 2016', location: 'Towson, MD')
...
Item.create!(
        title:          'Chinese Export Batavia ware jar',
...
Item.create!(
        title:          'Chinese Export Famille Rose paneled vase lamp',
...
Item.create!(
    title:              'Chinese Export Rose Mandarin water bottle',
...
Item.create!(
    title:              'Seven Chinese Export porcelain Immortals',
...
Item.create!(
    title:              'Chinese Export Famille Rose porcelain figure',
...
Item.create!(
    title:              'Chinese Export Rose Medallion oval platter',
...
Item.create!(
    title:              'Large Japanese Imari porcelain charger',
...
Item.create!(
    title:              'Pair Chinese cloisonne enamel jars',
...
Item.create!(
    title:             'Chinese Export blue and white garniture vase',
