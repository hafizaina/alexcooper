...
class AuctionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auction" do
    assert_difference('Auction.count') do
      post auctions_url, params: { auction: { date: @auction.date, location: @auction.location } }
    end
  ...
  test "should update auction" do
    patch auction_url(@auction), params: { auction: { date: @auction.date, location: @auction.location } }
