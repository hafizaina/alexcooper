...
class AuctionItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auction_item" do
    assert_difference('AuctionItem.count') do
      post auction_items_url, params: { auction_item: { auction_id: @auction_item.auction_id, item_id: @auction_item.item_id } }
    end
  ...
  test "should update auction_item" do
    patch auction_item_url(@auction_item), params: { auction_item: { auction_id: @auction_item.auction_id, item_id: @auction_item.item_id } }
